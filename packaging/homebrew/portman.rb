...
# result is copied into your tap repo (e.g. avlunvu/homebrew-tap).
#
...
class Portman < Formula
  ...
  homepage "https://github.com/avlunvu/lvdtvd-portman"
  version "0.1.0"
  license "MIT"

  on_macos do
    on_arm do
      url "https://github.com/avlunvu/lvdtvd-portman/releases/download/v#{version}/portman-darwin-arm64"
      sha256 "__SHA_DARWIN_ARM64__"
    end
    on_intel do
      url "https://github.com/avlunvu/lvdtvd-portman/releases/download/v#{version}/portman-darwin-amd64"
      sha256 "__SHA_DARWIN_AMD64__"
    end
  end

  on_linux do
    url "https://github.com/avlunvu/lvdtvd-portman/releases/download/v#{version}/portman-linux-amd64"
